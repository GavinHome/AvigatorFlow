import LogicFlow, { EdgeConfig, GraphModel } from "@logicflow/core";
      ...
      getPulsShape() {
        ...
        return h(
          "svg",
          {
            ...
            viewBox: "0 0 1024 1024",
            class: "time-plus",
            onClick: (e: Event) => clickPlus(e, attributes),
            onMousedown: (e: Event) => mouseDownPlus(e, attributes),
            onMouseUp: (e: Event) => mouseDownPlus(e, attributes),
          },
          h("path", {
            fill: "#f17611",
